  ...
  context 'when configuring child components' do
    ...
    context 'with channels component' do
      ...
      it 'registers the channels configuration' do
        expect(described_class.channels).to be_an_instance_of(Appydave::Tools::Configuration::ChannelsConfig)
      end
        ...
        context 'when loading the channels' do
          ...
          context 'when setting new channel information' do
            it 'sets new channel information' do
              new_channel_info = Appydave::Tools::Configuration::ChannelsConfig::ChannelInfo.new('nc',
                                                                                                 'code' => 'nc',
                                                                                                 'name' => 'New Channel',
              ...
              reloaded_channels = Appydave::Tools::Configuration::ChannelsConfig.new
    ...
    context 'with channel projects component' do
      ...
      it 'registers the channel projects configuration' do
        expect(described_class.channel_projects).to be_an_instance_of(Appydave::Tools::Configuration::ChannelProjectsConfig)
      end
        ...
        context 'when loading the channel projects' do
          ...
          context 'when setting new channel project information' do
            it 'sets new channel project information' do
              new_channel_info = Appydave::Tools::Configuration::ChannelProjectsConfig::ChannelInfo.new(
              ...
              reloaded_channel_projects = Appydave::Tools::Configuration::ChannelProjectsConfig.new
